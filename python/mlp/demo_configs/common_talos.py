...
w_am = 0. # weight used for the minimization of the Angular momentum
w_am_track = 0. # weight used for the tracking of the Angular momentum
w_posture = 1.  # weight of joint posture task
w_rootOrientation = 5.  # weight of the root's orientation task
