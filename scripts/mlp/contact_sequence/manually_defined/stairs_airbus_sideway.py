...
q_ref = [
        ...
        1.45, 0.0, -0.611354, 1.059395, -0.448041,-0.001708,        #Left Leg
        -1.45, 0.0, -0.611354, 1.059395, -0.448041, -0.001708,      #Right Leg
         0.0, 0.006761,                                             #Chest
        0.25847 ,  1.3, -0.5, -1.8, 1.2, 0.2,  0.4,-0.005,  #Left Arm
        -0.25847 , -1.3, 0.5  , -1.8,-1.2,  -0.2,  0.4,-0.005,#Right Arm
        0.0, 0.0] + [0]*6

q_ref[0:2] = [-3.,-1.7575] ; v(q_ref) # move root position
q_ref[2] -= 0.015
